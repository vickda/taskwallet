    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="bg-[#000000b5] p-8 rounded-3xl w-96 text-center flex flex-col items-center">
        <h2 id='headername' className="text-3xl mb-6 text-white">
          <img src={logo1['src']} alt="Logo" className="w-16 h-16 mx-auto mb-2" />
          TaskWallet
        </h2>
        ...
        >
          <img src={GoogleIcon['src']} alt="Google Icon" className="w-8 h-8 mr-2" />
          Sign in with Google
        </button>
        ...
        >
          <img src={GitHubIcon['src']} alt="GitHub Icon" style={{background:'white'}}
